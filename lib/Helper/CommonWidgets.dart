...
setCommonText(String title, dynamic color, dynamic fontSize, dynamic fontweight,
    dynamic noOfLine, TextAlign textAlign) {
        ...
        new Container(
          ...
          child: new GestureDetector(
            ...
            child: new Material(
              ...
              child: new Center(
                child: setCommonText('Start Exploring', Colors.white, 14.0,
...
showSnackbar(
    String value, GlobalKey<ScaffoldState> scaffoldKey, BuildContext context) {
  ScaffoldMessenger.of(context).showSnackBar(new SnackBar(
      ...
      content: new Row(
        children: <Widget>[
          ...
          SizedBox(width: 15),
          new Expanded(
              child: setCommonText(value, AppColor.white, 17.0, FontWeight.w500,
                  2, TextAlign.start))
        ],
      )));
}

commonAppbar(String title, List<Widget> action) {
  return AppBar(
    title: setCommonText(
